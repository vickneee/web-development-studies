...
The difference between these two methods is that sendStatus() will set the status and send the response. 

The status() method only sets the status. See the examples below:
